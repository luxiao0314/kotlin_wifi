 ...
 * @Version
 */
class FriendAdapter(layoutResId: Int, data: List<FriendsListResponse.ListBean>) :
        BaseQuickAdapter<FriendsListResponse.ListBean, BaseViewHolder>(layoutResId, data) {

    override fun convert(helper: BaseViewHolder, item: FriendsListResponse.ListBean, positions: Int) {
